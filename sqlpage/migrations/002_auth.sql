...
CREATE TABLE IF NOT EXISTS "accounts" (
    ...
    "rights" TEXT NOT NULL CHECK ("rights" IN ("read", "write", "admin"))
);
...
('admin', '$argon2id$v=19$m=19456,t=2,p=1$4lu3hSvaqXK0dMCPZLOIPg$PUFJSB6L3J5eZ33z9WX7y0nOH6KawV2FdW0abMuPE7o', 'admin');